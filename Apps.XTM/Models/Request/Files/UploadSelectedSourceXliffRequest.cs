...
{
    [Display("Match type", Description = "Match names replaces an existing source file with the same name. No match adds a new file and renames it if needed. Defaults to Match names.")]
